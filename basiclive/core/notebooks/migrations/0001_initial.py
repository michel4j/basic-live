...
def seed_default_data(apps, schema_editor):
    Theme = apps.get_model('notebooks', 'Theme')
    for name in ['default', 'floral']:
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('theme', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='notebooks.theme')),
            ],
        ),
        migrations.CreateModel(
            name='Page',
